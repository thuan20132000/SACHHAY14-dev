...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => '/sach','middleware'=>'admin'], function () {
        ...
        Route::post('sua','SachController@postSua')->name('admin/sach/postsua');
    ...
    Route::group(['prefix' => '/chuong','middleware'=>'admin'], function () {
        ...
        Route::get('sua/{id_sach}/{chuong}','ChuongController@getSua')->name('admin/chuong/sua');
        Route::post('sua','ChuongController@postSua')->name('admin/chuong/postsua');
        Route::get('xoa/{id_sach}/{chuong}','ChuongController@getXoa')->name('admin/chuong/xoa');
        Route::post('xoa','ChuongController@postXoa')->name('admin/chuong/postxoa');
    ...
    Route::group(['prefix' => '/laysach','middleware'=>'admin'], function () {
...
Route::post('timkiem','pagesController@getTimKiem')->name('user/timkiem');
